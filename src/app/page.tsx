...
export default function Home() {
  ...
  const changePage = () => {
    return router.push('/dashboard/surveys/create')
  };
    ...
    <div className="h-screen pl-40 grid justify-start content-center">
      <div className="w-[590px] self-stretch flex-col justify-start items-start gap-6 inline-flex">
        <div className="self-stretch h-[212px] flex-col justify-start items-start gap-6 flex">
          ...
          <div className="self-stretch ps-3 text-white text-6xl font-bold leading-[67.20px]">Create Your Survey Easily and Efficiently</div>

          <div className="self-stretch ps-3 text-white text-lg font-normal leading-7">Design and customize your surveys with our user-friendly form. Collect valuable insights and make data-driven decisions.</div>
        </div>
