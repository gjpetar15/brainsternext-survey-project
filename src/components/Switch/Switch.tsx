    ...
    <div>
      ...
      >
        <div className="relative">
          ...
          <div
            className={`dot absolute left-1 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-danger transition ${
              enabled && "!right-1 !translate-x-full !bg-success "
            }`}
          >
